...
model = dict(
    type='Mask2Former_LocalFeatures',##Mask2Former
    data_preprocessor=data_preprocessor,
    panoptic_head=dict(
        type='Mask2FormerHead_LocalFeaturePrompt',
        ...
        positional_encoding=dict(num_feats=128, normalize=True),
        localFeature_positional_encoding=dict(num_feats=50, normalize=True),#num_queries/2
        ...
        loss_dice=dict(
            ...
            eps=1.0,
            loss_weight=5.0),
        loss_localFeatures=dict(
            type='SmoothL1Loss',
            loss_weight=5.0)),
    panoptic_fusion_head=dict(
        type='MaskFormerFusionHead_LocalFeatures',##MaskFormerFusionHead
        num_things_classes=num_things_classes,
        num_stuff_classes=num_stuff_classes),
    train_cfg=dict(
        num_points=12544,
...
test_pipeline = [
    dict(
        ...
        to_float32=True,
        backend_args={{_base_.backend_args}}),
    dict(type='Resize_localFeature', scale=(1333, 800), keep_ratio=True),
    # If you don't have a gt annotation, delete the pipeline
    dict(type='LoadAnnotations_localFeature', with_bbox=True, with_mask=True),
    dict(
        type='PackDetInputs_localFeature',
...
val_evaluator = dict(
    _delete_=True,
    type='CocoMetric_LocalFeatures',##CocoMetric
    ann_file=data_root + '2_centerline_3typecen_instances_val.json',
    metric=['bbox', 'segm'],
    format_only=False,
    backend_args={{_base_.backend_args}})
