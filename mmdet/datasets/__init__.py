...
#new
from .coco_localFeature import CocoDataset_localFeature
from .coco_SketchPoints import CocoDataset_SketchPoints
...
__all__ = [
    ...
    #new
    'CocoDataset_localFeature', 'CocoDataset_SketchPoints'
]
