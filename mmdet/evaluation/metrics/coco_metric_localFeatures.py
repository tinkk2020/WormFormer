...
class CocoMetric_LocalFeatures(BaseMetric):
    ...
    def __init__(self,
        ...
        allowed_metrics = ['bbox', 'segm', 'proposal', 'proposal_fast', 'localFeatures']
    ...
    def results2json(self, results: Sequence[dict],
        ...
        for idx, result in enumerate(results):
            ...
            ##liye
            localFeatures = result['localFeatures']
            # bbox results
            for i, label in enumerate(labels):
                ...
                ##liye
                data['localFeatures'] = localFeatures[i]
    ...
    def process(self, data_batch: dict, data_samples: Sequence[dict]) -> None:
        ...
        for data_sample in data_samples:
            ...
            ##liye
            result['localFeatures'] = pred['localFeatures'].cpu().numpy()
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        for metric in self.metrics:
            ...
            if metric == 'proposal':
                ...
                ##liye
                coco_eval.evaluate_localFeatures()
                coco_eval.accumulate()
                coco_eval.summarize()
