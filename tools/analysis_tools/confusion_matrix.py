...
def calculate_confusion_matrix(dataset,
    ...
    for idx, per_img_res in enumerate(results):
        ...
        avg=analyze_per_img_dets(confusion_matrix, gts, res_bboxes, score_thr,
...
def analyze_per_img_dets(confusion_matrix,
    ...
    for det_label in unique_label:
        ...
        for i, score in enumerate(det_bboxes[:,4]):
            det_match = 0
...
def main():
    ...
    plot_confusion_matrix(
        confusion_matrix,
        (dataset.metainfo['classes'],)+('backgound',),
        # dataset.metainfo['classes'] + ' '.join(tuple),
